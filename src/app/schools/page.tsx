    ...
    return (
        <main className="min-h-screen bg-white">
            <div className="relative bg-white overflow-hidden lg:min-h-screen">
                ...
                <div className="absolute top-[30%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] md:w-[600px] md:h-[600px] bg-[var(--main-page-secondary)] opacity-15 rounded-full blur-[100px] pointer-events-none"></div>
                ...
                <div className="absolute inset-0 pointer-events-none">
                    <div className="absolute top-[20%] left-[10%] lg:left-[15%] text-blue-200 transform -rotate-12 bg-white/50 p-2 rounded-xl border border-blue-100 backdrop-blur-sm">
                        <HiOutlineSearch size={32} />
                    </div>
                    <div className="absolute top-[20%] right-[10%] lg:right-[15%] text-blue-200 transform rotate-12 bg-white/50 p-2 rounded-xl border border-blue-100 backdrop-blur-sm">
                        <HiOutlineBookOpen size={32} />
                    </div>
                    <div className="absolute bottom-[25%] left-[10%] lg:left-[15%] text-blue-200 transform rotate-[-15deg] bg-white/50 p-2 rounded-xl border border-blue-100 backdrop-blur-sm">
                        <HiOutlineBeaker size={32} />
                    </div>
                    <div className="absolute bottom-[25%] right-[10%] lg:right-[15%] text-blue-200 transform rotate-[15deg] bg-white/50 p-2 rounded-xl border border-blue-100 backdrop-blur-sm">
