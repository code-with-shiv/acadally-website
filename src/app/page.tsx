    ...
    <main className="min-h-screen bg-white">
      <div className="relative overflow-visible md:overflow-hidden">
        ...
        <div className="hidden md:block absolute top-0 right-0 w-full md:w-1/2 h-full pointer-events-none z-0">
          <Image src="/main-bg.svg" alt="Background images contains happy students" width={840} height={723} className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-[45%] w-[130%] md:w-[130%] max-w-none opacity-40 md:opacity-70" />
        </div>
