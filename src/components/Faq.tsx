            ...
            <div className="max-w-7xl mx-auto flex flex-col gap-6 py-10 px-4 lg:px-20 lg:py-5 lg:block lg:gap-0">
                ...
                <div className="flex flex-col gap-6 lg:grid lg:grid-cols-2 lg:gap-20 lg:items-start">
                    ...
                    <div className="flex flex-col order-2 lg:order-2">
                        <div className="flex flex-col gap-4 lg:gap-6 mb-4 lg:mb-8">
                            {faqData.map((faq, index) => (
                                <motion.div
                                    ...
                                    className={`rounded-lg transition-all duration-300 overflow-hidden lg:rounded-[12px] ${openIndex === index
                                ...
                                >
                                    ...
                                    <AnimatePresence>
                                        {openIndex === index && (
                                            ...
                                            >
                                                <div className="px-3 pb-3 md:px-7 md:pb-8 lg:px-6 lg:pb-6 text-[10px] leading-[1.4] font-normal md:text-sm lg:text-base md:leading-relaxed opacity-90">
                                                    {faq.answer}
                                                </div>
                                            </motion.div>
                                        )}
                    ...
                    <div className="flex flex-col order-1 lg:order-1 gap-6 lg:gap-10">
                        {/* 1. Heading */}
                        <motion.div
                            initial={{ opacity: 0, x: -30 }}
                            whileInView={{ opacity: 1, x: 0 }}
                            ...
                            <Heading
                                as="h2"
                                className="font-medium text-[32px] leading-[1.2] lg:font-medium lg:text-[56px] lg:leading-[120%]"
                                text={"Frequently Asked Questions"}
                            />
                        </motion.div>

                        {/* 3. Search / Still have questions */}
                        <motion.div
                            initial={{ opacity: 0, x: -30 }}
                            whileInView={{ opacity: 1, x: 0 }}
                            viewport={{ once: true, margin: "-100px" }}
                            transition={{ duration: 0.5, delay: 0.2 }}
                            className="rounded-xl p-4 md:p-10 lg:p-6 relative lg:rounded-[12px]"
                            style={{
                            ...
                            <div className="flex flex-col gap-6 lg:gap-8">
                                <div className="flex flex-col gap-2 lg:gap-4">
                                    <h3 className="text-base font-semibold leading-[1.2] lg:text-4xl lg:font-semibold text-main-page-secondary">
                                        Still have questions?
                                    </h3>
                                    <p className="text-[12px] leading-[16px] font-normal text-[#000000CC] lg:text-[16px] lg:leading-[140%] lg:font-normal opacity-80">
