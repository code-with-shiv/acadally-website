...
const schools = [
    ...
    { id: 25, name: "Richmondd Convent School", logo: "/logo25.svg" },  
    { id: 26, name: "Kendriya Vidhyalaya", logo: "/logo26.svg" }, 
    { id: 27, name: "The Galaxy Education System", logo: "/logo27.svg" }, 
    { id: 28, name: "Springfields School", logo: "/logo28.svg" },
    { id: 29, name: "Sapphire International School", logo: "/logo29.svg" },  
    { id: 30, name: "Navodaya Vidyalaya Samiti", logo: "/logo30.svg" },
    { id: 31, name: "DPS Banglore West", logo: "/logo31.svg" },
    { id: 32, name: "Kamala Subramaniam CBSE School", logo:"/logo32.svg"},
    { id: 33, name: "JJ School Montessori", logo: "/logo33.svg" },  
    { id: 34, name: "G D Goenka Agra", logo: "/logo34.svg" },  
    { id: 35, name: "Lotus valley", logo: "/logo35.svg" },  
