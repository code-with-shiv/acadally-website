                ...
                <div className="flex flex-col items-center text-center gap-4 md:gap-8 lg:gap-12 w-full">
                    ...
                    <div className="our-story-main-left w-full flex flex-col items-center gap-4 md:gap-6">
                        <div className="animate-in fade-in slide-in-from-top-4 duration-1000">
                            <Button
                                text="AcadAlly Story"
                                classes="bg-[#1C4CC31A] text-main-page-secondary text-[10px] md:text-base font-medium md:font-bold px-[16px] py-2 md:px-8 md:py-2.5 rounded-[32px] md:rounded-full leading-[20px] md:leading-normal cursor-default"
                            />
                        </div>
