                ...
                <motion.div
                    ...
                    <div className="lg:w-1/2 flex flex-col bg-white">
                        <div className="p-5 md:p-8 flex-1 text-xs md:text-sm">
                            {/* Latest Tag */}
                            <p className="hidden md:block text-[#1C4CC3] font-bold mb-3 tracking-tight lg:text-[18px] lg:leading-[24px]">Read about our Latest blog</p>

                            <hr className="hidden md:block border-t border-[#EDEDED] mb-4" />

                            <h2 className="text-[20px] leading-snug font-semibold text-[#383838] md:text-[32px] md:leading-snug md:font-semibold md:text-[#383838] mb-3 tracking-tight">
                                Customised vs Standard Assessments
                            </h2>

                            <p className="text-gray-600 text-[12px] leading-[140%] font-normal md:text-sm md:font-medium md:leading-relaxed mb-4">
                                Education is changing fast, and choosing between <span className="text-[#1C4CC3] font-bold">customised</span> and <span className="text-[#1C4CC3] font-bold">standard</span> evaluations is a big topic. Customised assessments use AI to create tests that fit each student’s needs.
                            </p>
