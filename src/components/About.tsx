                ...
                <div className="flex flex-col-reverse lg:flex-row gap-8 lg:gap-12 items-center lg:items-stretch">
                    ...
                    >
                        ...
                        <div className="flex justify-center lg:justify-start mt-2">
                            <button className="bg-purple-primary text-white font-semibold px-10 py-4 rounded-2xl hover:bg-purple-primary/95 transition-all shadow-md hover:shadow-lg text-base sm:text-lg">
                                Teachers: Sign in
                            </button>
                        </div>
                    </motion.div>
